...
export const FieldLabel = styled.label`font-weight: bold;`;

export const FieldInput = styled.input`${baseFieldCSS};`;

export const FieldTextArea = styled.textarea`${baseFieldCSS} height: 100px;`;
...
export const StatusText = styled.div`text-align: center;`;
